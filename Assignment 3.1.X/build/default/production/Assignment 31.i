...
void enter_number_units(unsigned int n){
    display_7segment(n);
    clk_pulse(1);
}

void enter_number_dozens(unsigned int n){
    display_7segment(n);
    latch_pulse(1);
    _delay((unsigned long)((90)*(1000000/4000.0)));
}
...
void main(void) {
    ...
    uint8_t a=0 ;
    for (a=0 ; a<100 ; a++){
        enter_number_units(a%10);
        enter_number_dozens(a/10);
    }
    return;
}
