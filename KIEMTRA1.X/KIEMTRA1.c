...
void main(void) {
    ...
    Nhan_so(20);
    while(1){
    /*if (PORTCbits.RC5 == 1 && PORTCbits.RC7 == 0){
    LATAbits.LATA4 = 0;
    ...
    //////////          Công t?c 2                        ////////////
    //////////////////////////////////////////////////////////////////
    if (PORTCbits.RC7 == 1 &&PORTCbits.RC5 == 0){
    LATAbits.LATA4 = 0;
        if (PORTCbits.RC3 == 0 && S2_state == 0) S2_state = 1,a=1; 
    if (PORTCbits.RC3 == 1 && S2_state == 1) S2_state = 2,a=2; 
    if (PORTCbits.RC3 == 0 && S2_state == 2) S2_state = 3,a=3;
    if (S2_state == 3){
    dem2 = dem2+1 ;
    if (dem2>10) dem2 = 10 ;
    LATCbits.LATC4 = 1;
